...
Each of these requires nothing more than a short audio sample and a commercially available AI tool. The barrier to entry is negligible. The potential damage is catastrophic. [Action Fraud](https://www.actionfraud.police.uk/) has seen a sharp rise in reports involving AI-generated voice impersonation.
...
This works on video calls too, where [deepfake video](/blog/deepfake-playbook/) adds a visual layer to the same attack. When both voice and video can be faked, the only reliable verification is one that doesn't depend on either.
